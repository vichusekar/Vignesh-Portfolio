        ...
        <Card.Body style={{ display: 'flex', flexDirection: 'row', fontSize: 'medium' }} >
          ...
          <Card.Text style={{ fontSize: 'larger' }}>
            <b>
              ...
              <br /><br />
              Moving to the back end, I am proficient in server-side technologies like Node.js, Express.js and I have hands-on experience with database management in MongoDB.
              <br /><br />
